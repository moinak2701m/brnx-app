  ...
  useEffect(() => {
    ...
    runPaymentSimulation((step) => {
      ...
      if (step === 3) {
        addTransaction({
          type: 'transfer',
          purpose: activePayment.beneficiary?.purpose ?? 'family',
          beneficiaryName: activePayment.beneficiary?.name || 'Recipient',
        ...
        clearActivePayment()
        setTimeout(() => navigate('/send/success', { replace: true }), 600)
      }
    })
    ...
    <div className="flex flex-col min-h-full bg-white">
      <div className="flex flex-col px-6 pt-12 pb-8">
        ...
        >
          ...
          <h1 className="text-xl font-bold text-[#111827]">Sending money</h1>
