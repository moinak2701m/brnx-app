const STYLES = {
  ...
  created:            { label: 'CREATED',           color: '#f97316', bg: '#fff7ed' },
  payment_initiated:  { label: 'PAYMENT INITIATED', color: '#0061D3', bg: '#eff6ff' },
  received_in_wallet: { label: 'IN WALLET',         color: '#7c3aed', bg: '#f3e8ff' },
  received_in_bank:   { label: 'SETTLED',           color: '#16a34a', bg: '#f0fdf4' },
}
